...
using Robust.Client.UserInterface; // RimFortress
...
namespace Content.Client.ContextMenu.UI
{
    ...
    public sealed partial class ContextMenuPopup : Popup
    {
        ...
        public ContextMenuPopup (ContextMenuUIController uiController, ContextMenuElement? parentElement, Control? root = null) : base() // RimFortress
        {
            ...
            (root ?? UserInterfaceManager.ModalRoot).AddChild(this); // RimFortress
