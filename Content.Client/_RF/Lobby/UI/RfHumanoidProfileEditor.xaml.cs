...
namespace Content.Client._RF.Lobby.UI
{
    ...
    public sealed partial class RfHumanoidProfileEditor : BoxContainer
    {
        ...
        public RfHumanoidProfileEditor()
        {
            ...
            OpenImagesButton.OnPressed += _ => IoCManager.Resolve<IResourceManager>()
                .UserData.OpenOsWindow(ContentSpriteSystem.Exports);
        ...
        private void ReloadPreview()
        {
            ...
            PreviewDummy = _controller.LoadProfileEntity(Profile, null, ShowClothes.Pressed);
