...
public sealed partial class ActionsHotbarWidget : UIWidget
{
    ...
    private static readonly SpriteSpecifier CreateSelectionIcon =
    ...
    public ActionsHotbarWidget()
    {
        ...
        CreateStockpileButton.OnPressed += _
            => zoningController.CreateSelection(StockpileSystem.StockProto, CreateSelectionIcon);
