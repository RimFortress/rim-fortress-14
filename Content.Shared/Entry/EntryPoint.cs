...
namespace Content.Shared.Entry
{
    public sealed partial class EntryPoint : GameShared
    {
        ...
        public override void Init()
        {
            IgnorePrototypes();
            // RimFortress Start
            // TODO: remove this when https://github.com/space-wizards/space-station-14/pull/45453 will be merged
            _prototypeManager.PartialDirectory(new ResPath("/Prototypes/_RF"), 0);
            // RimFortress End
        }
