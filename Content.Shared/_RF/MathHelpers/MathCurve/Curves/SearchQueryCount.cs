...
public sealed partial class SearchQueryCountCurveSystem : MathCurveSystem<SearchQueryCount>
{
    [Dependency] private SharedNpcSearcherSystem _npcSearcher = default!;
