...
public sealed partial class EngagementPrototype : IPrototype
{
    ...
    /// </summary>
    [DataField]
    public Dictionary<string, EngagementRole> Roles = new();
...
/// </summary>
/// <param name="Force">If true, then consent is not required to become a party to this situation.</param>
/// <param name="InitiatorOnly">If true, then only the person who initiated the situation can take on this role.</param>
/// <param name="MinCount">The minimum number of participants with this role required for the situation to begin.</param>
/// <param name="MaxCount">The maximum number of participants with this role.</param>
/// <param name="AlwaysConditionCheck">
...
public partial record struct EngagementRole(
    ...
    bool AlwaysConditionCheck = false)
{
    /// <summary>
    ...
    /// <summary>
    /// The values that will be written to the agent's state when it takes on this role.
    /// </summary>
    [DataField]
