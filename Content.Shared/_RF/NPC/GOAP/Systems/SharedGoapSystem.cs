...
public abstract class SharedGoapSystem : EntitySystem, IGoapConditionCheker, IGoapActionPerformer
{
    ...
    public float ActionCost(Entity<GoapComponent?> ent, GoapAction action)
    {
        ...
        return ActionCost(ent, ent.Comp.State, action);
    }

    public void ActionStartup<T>(EntityUid target, T action) where T : BaseGoapAction<T>
    {
    ...
    /// <param name="action">GOAP action.</param>
    [PublicAPI]
    public void ActionStartup(EntityUid target, GoapAction action) => action.Startup(target, this);

    public void ActionShutdown<T>(EntityUid target, T action) where T : BaseGoapAction<T>
    {
    ...
    /// <param name="action">GOAP action.</param>
    [PublicAPI]
    public void ActionShutdown(EntityUid target, GoapAction action) => action.Shutdown(target, this);
    ...
    /// </summary>
    [PublicAPI]
    public void PlanShutdown(Entity<GoapComponent> ent)
    {
...
public interface IGoapActionPerformer
{
    ...
    /// <param name="target">Target entity.</param>
    /// <param name="action">GOAP action.</param>
    void ActionStartup<T>(EntityUid target, T action) where T : BaseGoapAction<T>;
    ...
    /// <param name="target">Target entity.</param>
    /// <param name="action">GOAP action.</param>
    void ActionShutdown<T>(EntityUid target, T action) where T : BaseGoapAction<T>;
}
