...
public sealed class AddAllowedTaskCommand : LocalizedCommands
{
    [Dependency] private readonly IEntityManager _entityManager = default!;
    [Dependency] private readonly IPrototypeManager _prototype = default!;

    public override string Command => "addallowedtask";
    public override string Description => Loc.GetString("add-allowed-task-command-description");
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (!_prototype.TryIndex<NpcTaskPrototype>(args[1], out var protoId))
        {
            shell.WriteLine(Loc.GetString(
                ...
                ("index", 2),
                ("prototypeName", "cmd-addallowedtask-prototype")));
            return;
        }

        _entityManager
            .System<NpcControlSystem>()
            .AddAllowedTask(targetUid.Value, protoId);
    }
